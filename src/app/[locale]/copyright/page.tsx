        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Metavision</strong> - Creators of the Superstar Baseball game</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Email: <a href="mailto:dmca@superstar-baseball.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@superstar-baseball.wiki</a>
            </p>
            <p>
            ...
            <p>
              Example attribution: <em>"Source: Superstar Baseball Wiki (superstar-baseball.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@superstar-baseball.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@superstar-baseball.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@superstar-baseball.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@superstar-baseball.wiki</a>
            </p>
            <p>
