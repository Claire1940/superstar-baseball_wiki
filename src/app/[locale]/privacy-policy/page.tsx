        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              with Valve Corporation (Steam) or the developers of Superstar Baseball. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@superstar-baseball.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@superstar-baseball.wiki</a>
            </p>
            <p>
