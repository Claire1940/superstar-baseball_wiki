        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              Roblox Corporation or Metavision (official developers of Superstar Baseball). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or Metavision (developers of Superstar Baseball). We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox game availability and updates may change without notice. We are not responsible for game access or content changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SUPERSTAR BASEBALL WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@superstar-baseball.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@superstar-baseball.wiki</a>
            </p>
            <p>
